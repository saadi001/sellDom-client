                    ...
                    <div className="p-6">
                         ...
                         <div className="mt-1">
                              <div className="flex items-center">
                                   <div className="flex items-center">
                                        <p className="font-semibold text-gray-700 dark:text-gray-200 flex items-center" tabindex="0" role="link">
                                             {sellers_name}
                         ...
                         <ol class="space-y-4 list-decimal list-inside text-gray-500 dark:text-gray-400 mt-4">
                              <>
