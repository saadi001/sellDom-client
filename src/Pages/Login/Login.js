...
const Login = () => {
     ...
     return (
          <div>
               <div className="w-full max-w-sm p-6 my-3 mx-auto bg-white rounded-md shadow-lg dark:bg-gray-800">
                    <h1 className="text-3xl font-semibold text-center text-gray-700 dark:text-white uppercase font-serif">Log in</h1>
                    ...
                    <form onSubmit={handleSubmit(handleLogin)} className="mt-6">
                         ...
                         <div className="mt-4">
                              <div className="flex items-center justify-between">
                                   <label className="block text-sm text-gray-800 dark:text-gray-200">Password<span className='text-red-500'>*</span></label>
                         ...
                         <div className="mt-6">
                              <button className="w-full px-4 py-2 uppercase tracking-wide text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
                                   Log in
                              </button>
                         </div>
                    </form>
