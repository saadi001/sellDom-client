...
const Footer = () => {
     return (
          <div>
               <footer className="bg-white dark:bg-gray-900 max-w-5xl mx-auto mt-5">
                    <div className="container p-6 mx-auto">
                              ...
                              <div className="w-full -mx-6 lg:w-2/5">
                                   <div className="px-6">
                                        <div className='flex items-center'>
                                             ...
                                             <Link to={'/'} href="#" className="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">SellDom</Link>
                                        </div>

                                        <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400">Join our platform. You can be user or seller.</p>
                              ...
                              <div className="mt-6 lg:mt-0 lg:flex-1">
                                   <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                        ...
                                        <div>
                                             ...
                                             <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+8801836530309</span>
                                             <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">SellDom@email.com</span>
                                        </div>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div>
                              <p className="text-center text-gray-500 dark:text-gray-400">© SellDom 2022 - All rights reserved</p>
                         </div>
                    </div>
               </footer>
          </div>
